...
layers = [
 ...
 maxPooling2dLayer(2,'Stride',2,'Name','maxpool_1')  % Using Max Pooling instead of Average
 convolution2dLayer(5,32,'Padding','same','Name','conv_2')
 maxPooling2dLayer(2,'Stride',2,'Name','maxpool_2')  % Using Max Pooling instead of Average
