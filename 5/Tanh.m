...
%% Define the LeNet-5 architecture using Tanh Activation
layers = [
 imageInputLayer([32 32 1],'Name','input')
 convolution2dLayer(5,16,'Padding','same','Name','conv_1')
 TanhLayer('tanh_1')  % Tanh activation after the first convolution layer
 averagePooling2dLayer(2,'Stride',2,'Name','avgpool_1')
 convolution2dLayer(5,32,'Padding','same','Name','conv_2')
 TanhLayer('tanh_2')  % Tanh activation after the second convolution layer
 averagePooling2dLayer(2,'Stride',2,'Name','avgpool_2')
 fullyConnectedLayer(120,'Name','fc_1')
 TanhLayer('tanh_3')  % Tanh activation after the first fully connected layer
 fullyConnectedLayer(84,'Name','fc_2')
 TanhLayer('tanh_4')  % Tanh activation after the second fully connected layer
